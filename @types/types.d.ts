...
export interface AccountBalanceResultInterface {
    "Result": {
        ...
        "ResultDesc"?: string;
        /** The unique identifier of the request message.
         *    This is auto-generated by M-PESA for third-party/Organizations. Its value comes from the response message.
         *    It can be used to check the status of the transaction.
         */
        "OriginatorConversationID": string;
...
export type TransactionStatusQueryCallback = { Result: BasicResults | SuccessResults };
